...
import { exerciseMediaAssetsRouter } from "./src/routes/exerciseMediaAssets.js";
...
import { hyroxEventsIpRateLimiter, hyroxEventsSessionRateLimiter, hyroxImportRateLimiter, hyroxIpRateLimiter, hyroxEmailRateLimiter, validateHyroxSubmission } from "./src/hyrox/hyroxValidator.js";
...
app.post("/api/hyrox/events", hyroxEventsIpRateLimiter, hyroxEventsSessionRateLimiter, createHyroxCalculatorEventsRouter(pool));
app.use("/api/hyrox/download-redirect", createHyroxDownloadRedirectRouter(pool));
