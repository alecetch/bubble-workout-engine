...
export const MUSCLE_GROUP_MAP = Object.freeze([
  ...
  { segmentKey: "sled_push", primary: ["quad_dominant", "push_shoulder"], secondary: ["core_stability", "posterior_chain"] },
  { segmentKey: "sled_pull", primary: ["posterior_chain", "upper_back_pull"], secondary: ["grip_forearm", "core_stability"] },
  { segmentKey: "burpee_broad_jump", primary: ["quad_dominant", "push_shoulder"], secondary: ["core_stability", "posterior_chain"] },
  { segmentKey: "row", primary: ["upper_back_pull", "posterior_chain"], secondary: ["grip_forearm", "core_stability"] },
  { segmentKey: "farmers_carry", primary: ["grip_forearm", "core_stability"], secondary: ["quad_dominant", "posterior_chain"] },
...
export const TRAINING_HINTS = Object.freeze({
  ...
  posterior_chain: "Romanian deadlifts, hip thrusts, and Nordic curls build the posterior-chain strength-endurance that Sled Pull and Row both rely on.",
  quad_dominant: "Front squats, step-ups, and sled-specific loading build the quad durability that all four pushing stations share.",
