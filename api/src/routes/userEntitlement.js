...
export function createUserEntitlementHandler(db) {
  return async function userEntitlementHandler(req, res) {
...
userEntitlementRouter.get("/users/me/entitlement", createUserEntitlementHandler(pool));
