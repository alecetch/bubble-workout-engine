...
INSERT INTO public.narration_template (
  ...
  NULL,
  NULL,
  '["{EX_NAME}: {SETS} x {PRESCRIPTION_TEXT}. Control the eccentric.","{EX_NAME}: {SETS} sets in {PRESCRIPTION_TEXT} chase tension, not momentum.","{EX_NAME}: {SETS} x {PRESCRIPTION_TEXT}. Keep the last reps hard but tidy."]'::jsonb,
  true,
  '2026-03-01T16:19:26.993Z',
  '2026-05-17T21:16:15.142Z'
)
ON CONFLICT (template_id) DO UPDATE SET
  scope         = EXCLUDED.scope,
  field         = EXCLUDED.field,
...
INSERT INTO public.narration_template (
  ...
  NULL,
  NULL,
  '["{EX_NAME}: {SETS} set(s) of {PRESCRIPTION_TEXT} @ ~{RIR} RIR. Tempo {TEMPO}.","{EX_NAME}: {SETS} x {PRESCRIPTION_TEXT}, leave {RIR} reps in reserve. Tempo {TEMPO}.","{EX_NAME}: {SETS} sets in the {PRESCRIPTION_TEXT}. Keep {RIR} RIR and controlled tempo ({TEMPO})."]'::jsonb,
  true,
  '2026-03-01T16:19:26.993Z',
...
INSERT INTO public.narration_template (
  ...
  '["{EX_NAME}: {SETS} x {PRESCRIPTION_TEXT}"]'::jsonb,
  true,
  '2026-04-03T17:49:01.096Z',
  '2026-04-04T00:00:00.000Z'
)
ON CONFLICT (template_id) DO UPDATE SET
  scope         = EXCLUDED.scope,
...
INSERT INTO public.narration_template (
  ...
  NULL,
  NULL,
  '["{EX_NAME}: {SETS} x {PRESCRIPTION_TEXT}. Smooth reps, {RIR} RIR.","{EX_NAME}: {SETS} sets of {PRESCRIPTION_TEXT} with control; no grinders.","{EX_NAME}: {SETS} x {PRESCRIPTION_TEXT}. Add load only if reps stay clean."]'::jsonb,
  true,
  '2026-03-01T16:19:26.993Z',
  '2026-05-17T16:52:24.197Z'
)
ON CONFLICT (template_id) DO UPDATE SET
  scope         = EXCLUDED.scope,
  field         = EXCLUDED.field,
...
INSERT INTO public.narration_template (
  ...
  'hypertrophy_prog_summary_v1',
  'program',
  'PROGRAM_SUMMARY',
  1,
  NULL,
  NULL,
  '{"program_type":"hypertrophy"}'::jsonb,
...
INSERT INTO public.narration_template (
  ...
  'strength_prog_summary_v1',
  'program',
  'PROGRAM_SUMMARY',
  1,
  NULL,
  NULL,
  '{"program_type":"strength"}'::jsonb,
  '["Three focused sessions per week with a main lift, a secondary pattern, and short accessories. Keep effort at ~{RIR} RIR on most work and progress steadily.","A simple, repeatable strength week: main movement first, then secondary volume, then a tight accessory finisher. Prioritise clean reps and consistent loading.","Built for consistency: key compounds each week, then targeted accessories. Aim to add small load or reps week-to-week while keeping form sharp."]'::jsonb,
  true,
  '2026-04-04T16:55:37.321Z',
  '2026-04-04T16:55:37.321Z'
)
ON CONFLICT (template_id) DO UPDATE SET
  scope         = EXCLUDED.scope,
...
INSERT INTO public.narration_template (
  ...
  NULL,
  '{"program_type":"strength"}'::jsonb,
  '["{DAYS_PER_WEEK}-Day Strength ( {DURATION_MINS} min )","Strength Builder - {DAYS_PER_WEEK} Days / Week","Strength ( {DURATION_MINS}-Minute Sessions )"]'::jsonb,
  true,
  '2026-04-04T16:47:13.536Z',
  '2026-04-04T16:53:21.412Z'
)
ON CONFLICT (template_id) DO UPDATE SET
  scope         = EXCLUDED.scope,
  field         = EXCLUDED.field,
...
INSERT INTO public.narration_template (
  ...
  'amrap',
  '{"program_type":"hyrox"}'::jsonb,
  '["Block {SEGMENT_LETTER} - AMRAP"]'::jsonb,
  true,
  '2026-03-14T11:13:49.900Z',
  '2026-04-03T12:10:16.479Z'
)
ON CONFLICT (template_id) DO UPDATE SET
  scope         = EXCLUDED.scope,
  field         = EXCLUDED.field,
