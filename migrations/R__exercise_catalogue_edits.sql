...
-- Generated: 2026-03-20 19:18:14 UTC
-- Row count: 134
...
INSERT INTO exercise_catalogue (
  ...
  2,
  NULL,
  '["conditioning_main","finisher","hyrox_buy_in","ski_erg"]'::jsonb,
  'run_interval',
  'locomotion_compound',
  '[]'::jsonb,
  '[]'::jsonb,
...
INSERT INTO exercise_catalogue (
  ...
  0,
  NULL,
  '["conditioning_main","hyrox_station","ski_erg"]'::jsonb,
  'ski_erg',
  'cyclical_compound',
  '["cardio"]'::jsonb,
  '["general_heat"]'::jsonb,
